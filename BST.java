...
public class BST<T> {
   ...
   */
   public T getRoot() throws NoSuchElementException{
	   if(isEmpty()) {
		   throw new NoSuchElementException(" getRoot(): tree is empty, cannout get root");
	   }
      return root.data;
   }
   ...
   */
   public T findMin() throws NoSuchElementException{
	   if(isEmpty()) {
		   throw  new NoSuchElementException(" findMin(): cannot find min value due to tree being empty  ");
	   }
      return findMin(root);
   }
   ...
   */
   public T findMax() throws NoSuchElementException{
	   if(isEmpty()) {
		   throw  new NoSuchElementException(" findMax(): cannot find max value due to tree being empty  ");
	   }
      return findMax(root);
   }
